			...
			<div class="header-container" style="{if $page_name == 'index'}height: 100%;{/if}">
				<header id="header" style='{if $page_name == "index"}height: 100%;{else}background-color:#252525;{/if}'>
					{if $page_name == "index" && $headerMediaItems}
						{if $WK_HEADER_MEDIA_TYPE == $WK_HEADER_MEDIA_TYPE_IMAGE}
							...
							{else}
								<div class="header-media-layer header-media-slider">
									<div class="owl-carousel header-img-carousel"
										...
										data-anim-type="{if isset($headerSliderConfig.anim_type)}{$headerSliderConfig.anim_type|intval}{else}{HotelHeaderMedia::ANIM_TYPE_SLIDE}{/if}"
										>
								...
								{if isset($headerSliderConfig.nav_type) && $headerSliderConfig.nav_type != $WK_HEADER_NAV_TYPE_DOTS}
						...
						{elseif $WK_HEADER_MEDIA_TYPE == $WK_HEADER_MEDIA_TYPE_VIDEO}
								...
								<video class="header-bg-video"
									...
									{if $singleVid.source_type == 'url' || $singleVid.name|substr:0:4 == 'http' || $singleVid.name|substr:0:2 == '//'}
										<source src="{$singleVid.name|escape:'html':'UTF-8'}"
												type="{if $singleVid.name|substr:-4 == 'webm'}video/webm{elseif $singleVid.name|substr:-3 == 'ogv' || $singleVid.name|substr:-3 == 'ogg'}video/ogg{else}video/mp4{/if}">
									{else}
